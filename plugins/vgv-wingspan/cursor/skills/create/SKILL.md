...
2. Then use **host structured question tool (AskQuestion on Cursor; AskUserQuestion on Claude Code)**:
...
If **no skills from that plugin are listed**, the plugin is not installed. Use **host structured question tool (AskQuestion on Cursor; AskUserQuestion on Claude Code)**:
...
- Every user-facing question must use the **host structured question tool (AskQuestion on Cursor; AskUserQuestion on Claude Code)**.
