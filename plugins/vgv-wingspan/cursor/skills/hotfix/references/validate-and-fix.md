...
- After 3 failed attempts, use **AskQuestion** (Cursor) / **AskUserQuestion** (Claude Code) to ask the user for guidance with context on what failed and what you tried
