...
Use **AskQuestion** (Cursor) / **AskUserQuestion** (Claude Code) to confirm before committing (**Yes** / **No** / **Edit**). On confirm, commit with a HEREDOC to preserve formatting. Do not push yet.
