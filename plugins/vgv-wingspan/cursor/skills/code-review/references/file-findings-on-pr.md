...
Use **AskQuestion** (Cursor) / **AskUserQuestion** (Claude Code): "Which findings should I file on the PR?"
...
Then use **AskQuestion** (Cursor) / **AskUserQuestion** (Claude Code): "How should I post these <N> findings?"
