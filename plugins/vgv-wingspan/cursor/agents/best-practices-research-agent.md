...
description: 'Researches and synthesizes best practices for the project''s technology stack, following first VGV conventions and the project''s AGENTS.md, then official language and framework documentation, and finally other industry standards.'
...
1. **Discover Available Skills**:
   - Use Glob to find all SKILL.md files: `**/**/SKILL.md` and `~/.cursor/skills/**/SKILL.md`
   - Also check project-level skills: `.cursor/skills/**/SKILL.md`
   - Read the skill descriptions to understand what each covers

1. **Extract Patterns from Skills**:
...
1. **Detect Project Conventions**:
   - Read the project's AGENTS.md for established conventions
...
1. **Report findings before proceeding** - do not recommend deprecated APIs
